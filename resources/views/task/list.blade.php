                ...
                <div class="p-6 text-gray-900">
                    <div class="d-flex mb-2">
                        <div id="add" class="d-flex justify-content-start pt-2 align-items-center">
                            <div class="a-button" data-url="task/create">
                                &nbsp; + &nbsp;
                            </div>
                        </div>
                    ...
                    <table class="w-100 p-1">
                        ...
                        <tbody id="content">
                            ...
                            @foreach($list as $val)
                            @php
                            $progress = count($val->subtasks) > 0 ? ($val->done_tasks / count($val->subtasks) * 100) : '-';
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <button type="button" class="action btn btn-link" data-action="edit" data-id="{{ $val->id }}">Edit</button>
                                    <button type="button" class="action btn btn-link" data-action="delete" data-id="{{ $val->id }}">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                            @else
